...
describe('generateNumericValue', () => {
  it('should generate numbers centered around the average', () => {
    ...
    expect(numbers).toEqual([
      109.74563710391521, 96.9760662317276, 101.26386724412441, 109.98033925890923,
      106.58302195370197, 92.64956168830395, 106.50991648435593, 106.77365444600582,
      92.26082369685173, 91.17857791483402,
    ]);
  });
