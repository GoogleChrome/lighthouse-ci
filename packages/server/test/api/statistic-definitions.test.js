...
/** @type {any} */
const baselhr920_ = require('../fixtures/lh-9-2-0-coursehero-a.json');
...
describe('Statistic Definitions', () => {
  ...
  describe('meta_lighthouse_version()', () => {
    ...
    it('should extract the version', () => {
      ...
      expect(run([baselhr920])).toEqual({value: 90200});
  ...
  describe('audit_interactive_median()', () => {
    ...
    it('should extract the median value', () => {
      ...
      expect(run([high, baselhr920, low]).value).toBeCloseTo(18422.752);
    });
  });
  ...
  describe('category_performance_median()', () => {
    ...
    it('should extract the median value', () => {
      ...
      expect(run([high, baselhr920, low]).value).toBeCloseTo(0.26);
    });
  });
  ...
  describe('category_performance_min()', () => {
    ...
    it('should extract the min value', () => {
      ...
      expect(run([high, baselhr920, low]).value).toBeCloseTo(0.01);
    });
  });
  ...
  describe('category_performance_max()', () => {
    ...
    it('should extract the max value', () => {
      ...
      expect(run([high, baselhr920, low]).value).toBeCloseTo(0.99);
    });
  });
  ...
  describe('auditgroup_a11y-aria_*()', () => {
    it('should extract the group count', () => {
      ...
      expect(definitions['auditgroup_a11y-aria_pass']([baselhr920])).toEqual({value: 8});
      ...
      expect(definitions['auditgroup_a11y-color-contrast_fail']([baselhr920])).toEqual({value: 1});
      ...
      expect(definitions['auditgroup_a11y-aria_na']([baselhr920])).toEqual({value: 9});
    });
  });
});
